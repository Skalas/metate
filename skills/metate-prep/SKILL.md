...
description: |
  ...
  seeds human-validation gates (H1…Hn) when `smoke.humanGates` is configured, and
...
4. **File the ledger** — when `prep.issues.create` is true, turn the text plan into issues:
